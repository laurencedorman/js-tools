...
* **webpack:** set devPublicPath ([4d2f4ea](https://github.com/manomanotech/js-tools/commit/4d2f4ea))
...
* **webpack:** fix webapck dev server options to work with manomano-sf ([db06d6e](https://github.com/manomanotech/js-tools/commit/db06d6e))
...
* **webpack:** add environment variable for webpack dev server host ([a6e9df9](https://github.com/manomanotech/js-tools/commit/a6e9df9))
...
* **webpack:** Add SSR assets inside webpack build ([6cdf919](https://github.com/manomanotech/js-tools/commit/6cdf919))
...
* **webpack:** Add analyze option ([a77faad](https://github.com/manomanotech/js-tools/commit/a77faad))
...
## [2.5.8](https://github.com/manomanotech/js-tools/compare/v2.5.7...v2.5.8) (2019-06-07)
...
* **webpack:** switch chunkhash to contenthash in chunk webpack config ([867184c](https://github.com/manomanotech/js-tools/commit/867184c))
...
* **webpack:** removed port in webpack dev server address when used with docker container ([ffa9a95](https://github.com/manomanotech/js-tools/commit/ffa9a95))
...
* **webpack:** fix SSL error when trying to load webpack dev server assets when required from manomano-sf in docker env ([cc02b43](https://github.com/manomanotech/js-tools/commit/cc02b43))
...
* **webpack:** fix template not workin on dev. ([4a8720e](https://github.com/manomanotech/js-tools/commit/4a8720e))
...
* **webpack:** generate an index file for each supported platform ([020a212](https://github.com/manomanotech/js-tools/commit/020a212))
