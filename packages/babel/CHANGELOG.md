...
* **babel:** Only traverse languages specified on manoConfig ([afdb4c3](https://github.com/manomanotech/js-tools/commit/afdb4c3))
...
* **babel:** Fix dynamic import when extracting translations ([6ae1b61](https://github.com/manomanotech/js-tools/commit/6ae1b61))
...
* **babel:** Only traverse js or jsx files when extracting translations. ([269c58b](https://github.com/manomanotech/js-tools/commit/269c58b))
